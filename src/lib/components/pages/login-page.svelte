...
<div class="m-auto h-full max-w-[400px] content-center px-2">
  ...
  <h2 class="mb-4 text-center text-sm text-muted-foreground">
    Start schedging today.
  </h2>
  ...
  <Tabs.Root value={SIGNIN}>
    ...
    <div class="min-h-[354px]">
      <Tabs.Content value={SIGNIN}>
        <Card.Root>
          <Card.Content class="space-y-2">
            <LoginForm schemaForm={loginSchema} actionStr="?/login" />
          </Card.Content>
        </Card.Root>
      </Tabs.Content>
      <Tabs.Content value={SIGNUP}>
        <Card.Root>
          <Card.Content class="space-y-2">
            <LoginForm schemaForm={registerSchema} actionStr="?/register" />
          </Card.Content>
        </Card.Root>
      </Tabs.Content>
    </div>
